...
#define TOUCH_XPT2046_MISO 15
#define TOUCH_XPT2046_MOSI 2
#define TOUCH_XPT2046_CS 0
#define TOUCH_XPT2046_INT 13
...
int16_t touch_map_x1 = 3889;
int16_t touch_map_x2 = 240;
int16_t touch_map_y1 = 3846;
int16_t touch_map_y2 = 149;
